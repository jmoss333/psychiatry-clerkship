...
def test_shipped_page_sources_exist_in_repo():
    # 128 shipped surfaces, not the 91 the site manifest alone lists: +26 Case-of-the-Week
    ...
    assert len(md_entries) == 101  # 69 manifest md + 26 case-of-the-week + 6 resident
