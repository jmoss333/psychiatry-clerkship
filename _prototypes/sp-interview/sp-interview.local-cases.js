(function (root, factory) {
  ...
  var caseDef = {
    ...
    intents: [
      ...
      {id:'open_invite',label:'Used an open invitation',category:'technique',coverage:'core',patterns:['tell me (?:a little |a bit )?(?:more )?about','what(?: has|\\’s|\'s) been (?:going on|happening)','where would you like to (?:start|begin)','how do you see']},
      ...
      {id:'explore_benefits',label:'Explored perceived benefits',category:'data',coverage:'core',patterns:['what do you (?:like|get) (?:about|from)','how does (?:drinking|alcohol) help','good things about','benefits?','what does it do for you','what does (?:it|drinking|alcohol) give you']},
      ...
      {id:'values',label:'Explored values and priorities',category:'technique',coverage:'core',patterns:['what matters','important to you','your values','kind of (?:parent|person)','independence','reliable','maya','workday mornings','wants? to protect']},
