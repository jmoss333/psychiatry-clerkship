...
(function (root, factory) {
  ...
  var OVERLAY={id:'dana-direct-si-v1',status:'draft-pending-faculty-review',sourceGateHash:SOURCE_GATE_HASH,scope:'Correct direct suicide questions disclose the authored disclosure response regardless of rapport or earlier flags; follow-up depth gates are unchanged.'};
