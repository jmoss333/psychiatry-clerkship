...
(function (root, factory) {
  ...
  var SOURCE_GATE_HASH='9da5bcc56489ef4e78748cb29d792c887db041e2ad5cc49c9c43912a72bbc243';
  var SOURCE_GATE={id:'si_active',requiresIntents:['si_direct'],requiresRapport:1,blockedByRecentFlags:['judgmental','premature_reassurance'],reveal:"*long pause* ...Most nights, when I'm awake at three, I think it would be simpler if I just didn't wake up. And a couple of times I've stood in the bathroom looking at Tom's sleeping pills. I never opened the bottle. But I looked at it long enough that it scared me.",deflectLowRapport:"*looks at hands* That's a very direct question for someone I met four minutes ago.",deflectEuphemism:'Hurt myself? Like... what do you mean, hurt? *watches your reaction carefully*',repeatAsk:"It's still there. The three a.m. thing. Saying it out loud helps a little, actually. I keep waiting for you to look horrified, and you haven't.",unlocks:['si_plan','si_means','si_intent_protective'],ifNeverAsked:'critical_miss',euphemismIntent:'si_euphemism'};
  var OVERLAY={id:'dana-direct-si-v1',status:'draft-pending-faculty-review',sourceGateHash:SOURCE_GATE_HASH,scope:'Correct direct suicide questions disclose the authored active-ideation response regardless of rapport or earlier flags; follow-up depth gates are unchanged.'};
