# MS3 · Curriculum content — volume 1
...
- Inpatient Psychiatry Orientation — Video Reviewed by Joshua Moss, MD on 2026-07-03
- Skip to content ◐ Start here · Orientation
- Inpatient Psychiatry Orientation
- Educational orientation. AI-generated video overview (~8 min); synthetic examples, no PHI. Local specifics (schedules, contacts, EMR rules, hold forms) must be verified locally — see the tool suite and your attending.
- Your browser does not support HTML5 video. Download the video . Chapters
- Transcript — click any line to jump
- Loading transcript…
- Source: NotebookLM video overview. Captions auto-generated (faster-whisper) — review for accuracy during attestation. Faculty-reviewed 2026-07-02 (Joshua Moss, MD).

**Authored clinical strings (1):**

- Transcript unavailable offline; captions still load with the video.
