# RESIDENT · Appendix A5 — Coverage matrices
...
| `personality` | 2 | `cotw_20260827_bpd_res.md`, `t_personality.md` |
...
`adv_psychopharm.md`, `anki.md`, `book_library.md`, `canon_200.md`, `case_formulation.md`, `cases.md`, `cl_reference.md`, `collateral_workflow.md`, `core_readings.md`, `cotw_index.md`, `ddx.md`, `evidence_inpatient.md`, `exp_tx.md`, `omm_resources.md`, `orientation.md`, `osce.md`, `pg_formulation.md`, `pg_interview.md`, `podcast_library.md`, `psychotherapy.md`, `rapid_review.md`, `reading_map.md`, `rotation.md`, `rounds_questions.md`, `shelf.md`, `supervision_teaching.md`, `systems_medlegal.md`, `therapy_on_the_unit.md`, `therapy_reading_room.md`, `week1.md`, `week2.md`, `week3.md`, `week4.md`, `week5.md`, `week6.md`, `welcome.md`
