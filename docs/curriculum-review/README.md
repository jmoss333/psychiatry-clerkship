...
Generated 2026-09-02 from build `08ea900` by
...
| Words of curriculum | 98,921 | 118,325 |
...
| Evidence sources / annotated claims | 106 / 48 | 106 / 48 |
| Complete transcript | `ms3/MS3_CURRICULUM_COMPLETE.md` (2,358,209 B) | `resident/RESIDENT_CURRICULUM_COMPLETE.md` (2,608,286 B) |
