...
Generated 2026-09-02 from build `bfced1f` by
...
| Words of curriculum | 98,742 | 117,851 |
...
| Evidence sources / annotated claims | 105 / 47 | 105 / 47 |
| Complete transcript | `ms3/MS3_CURRICULUM_COMPLETE.md` (2,355,497 B) | `resident/RESIDENT_CURRICULUM_COMPLETE.md` (2,603,496 B) |
