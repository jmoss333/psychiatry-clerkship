...
> All PMIDs below passed identity + retraction verification (2026-08-20) and the Scholar Sidekick canonical pass (2026-08-21): retraction/errata sweep clean (errata noted in the staging registry), open-access links finalized via Unpaywall, citations regenerated. **Annotations were regenerated from the papers' abstracts on 2026-08-21 per the faculty editorial directives of the same date — every annotation is a draft awaiting Dr. Moss's signature.**
