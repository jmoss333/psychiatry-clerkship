...
nav=[
 ...
 {"section":"Practice","items":[dict({"t":n,"f":d,"k":"tool"},**({"hidden":True} if d in HIDDEN_TOOLS else {})) for s,d,n in tools]},
 ...
 {"section":"Faculty","group":"Evidence & reference","items":[{"t":"Review & Attest","f":"review-attest.html","k":"tool"},{"t":"Question Bank Attestation","f":"qbank-attest.html","k":"tool"}]},
]
