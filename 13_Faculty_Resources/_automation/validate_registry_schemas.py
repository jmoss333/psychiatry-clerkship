#!/usr/bin/env python3
"""Validate the fourteen tracked registries against their Draft-07 JSON Schemas."""
...
def validate_root(root: Path) -> tuple[list[str], bool]:
    """Return deterministic diagnostics for the fourteen fixed registry/schema pairs."""
    diagnostics = []
    has_errors = False
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="repository root containing the fourteen fixed registry/schema pairs",
    )
