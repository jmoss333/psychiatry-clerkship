...
| D7 | Treat a green scheduled health receipt as the only release evidence | Reject: a learner-ready success proves the bounded contract plus one actor reply, not evaluator/safety-screen/voice behavior or clinical quality; it never replaces this deploy/model/pack checklist or faculty/privacy activation gates |
