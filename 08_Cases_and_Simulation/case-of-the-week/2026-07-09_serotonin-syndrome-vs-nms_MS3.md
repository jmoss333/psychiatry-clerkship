...
4. **Escalate on severity, not on the antidote.** **Severe SS** — rapidly rising temperature (> 39–41 °C), rigidity, altered consciousness, or failure to respond to initial cooling — needs **ICU care, sedation, and intubation with neuromuscular paralysis using a non-depolarizing agent (avoid succinylcholine — hyperkalemia risk with rhabdomyolysis)** to stop muscular heat generation [1][2][7]. This is the step that saves lives, and nothing should delay it.
