...
**Q3. At 6 weeks she reports feeling "maybe a little better" and her PHQ-9 has moved 16 → 13. What defines an "adequate trial," and what are her next options?**
*Teaching point:* An adequate trial = **adequate dose for adequate duration (≥6–8 weeks)**. First name the change correctly, because the label drives the plan: a 16 → 13 PHQ-9 move is a **minimal response** (Q2) — it is below the ~5-point step that is clinically meaningful — so it is not a partial response — and although at 6 weeks on an adequate dose she has reached the lower bound of an adequate trial, it is not yet clearly a failed one. That is the honest reading at 6 weeks, and the next step follows from it: **optimize the dose** of the current SSRI and complete the trial to 6–8 weeks at that dose, rechecking adherence and tolerability, before deciding between switching and augmenting. Distinguish the three strategies: optimize = push the same drug up; switch = replace it; augment = add a second agent to the first.
...
5. NHS Specialist Pharmacy Service. *SSRIs to other antidepressants: switching in adults.* Updated 2024. [Article](https://sps.nhs.uk/articles/ssris-to-other-antidepressants-switching-in-adults/)
