...
const DELIVERY=Object.freeze({
  sp_mania_redirect_001:'Delivery: Marcus has pressured speech in this authored encounter. Speak with an urgent, continuous forward momentum: rapid but intelligible connected phrases, compressed pauses between clauses, and little sense of settling at each sentence ending. Let the supplied shifts of idea sound spontaneous. Vary emphasis and pitch with genuine interest in his own ideas; avoid a uniformly cheerful presenter voice. A brief objection can sound irritated without shouting or becoming menacing. If the words acknowledge a clear redirect, make that acknowledgement audible and follow the new topic while retaining his brisk cadence. Do not invent distractions, repeat words, run past the supplied text, or add symptoms. This is one patient portrayal, not a claim about everyone with mania.',
...
For this Marcus portrayal, pressure of speech concerns how a thought carries on as well as its pace. In an open invitation, allow a brief connected shift between ideas already established in his case. Keep the connection understandable; do not recite unrelated symptoms, repeat yourself to fill time, or invent projects, room events, distractions, people, or history.
...
export function refineActorContext(context,caseId){
  ...
  return {...context,system:context.system+MARCUS_TURN_STYLE};
}
