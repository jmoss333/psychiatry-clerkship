...
| H7 · Room event | One of four allowlisted cues (`door_knock`, `hallway_chime`, `door_tap`, `overhead_page`); unsupported/repeated IDs fail before spending. Pause retains completed draft and displays unfinished words separately without auto-sending them. No new visitor, danger or disclosure permission. Retry before the cue excludes it. |
