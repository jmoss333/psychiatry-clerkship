...
export default async function handler(request,context){
 try{
  ...
  if(!env.DEPLOY_ID||env.DANA_PREVIEW_ENABLED!=='true'||env.DANA_MOMENTS_ENABLED!=='true')return Response.json({error:'preview_unavailable'},{status:503,headers:{'Cache-Control':'no-store'}});
