...
test('every data-fd attribute emitted after Task 3 has one controller meaning', () => {
  ...
  // moment a renderer emits the theme radio group again. 'data-fd-close-settings' is registered in
  // fd_wire.js but emitted by nothing, so it is deliberately absent.
