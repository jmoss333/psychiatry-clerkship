...
const EXPECTED_MARKER_COUNT = 15; // SM2_APPLY_GRADE, PHI_HEURISTIC, SW_REGISTER, CALIB_LOG, PHASE_POLICY, SESS_CAPSULE, FD_STATE, FD_DATA, FD_TODAY, FD_SHELL, FD_PATH, FD_LIBRARY, FD_READER, FD_SEARCH, FD_SHEET — bump when adding a marker
