...
- **Follow-up is often the weak link.** Roughly one in eight psychiatric inpatients is readmitted within 30 days (more with schizophrenia), and in many samples only about half attend a mental-health visit within 7 days (e.g., Haselden 2019, NY Medicaid: 53%). A *scheduled* appointment (not "they'll call to arrange one") is itself the intervention — pre-discharge 7-day follow-up is associated with substantially lower suicide risk.
